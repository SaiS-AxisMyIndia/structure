...
import { useNeedsSController } from './NeedsSController';

export function NeedsSBody() {
  const controller = useNeedsSController();
      ...
      body={
        summary ? (
          <>
            ...
            <Text style={styles.stat}>Open needs: {summary.openNeedsCount}</Text>
          </>
        ) : null
      }
    />
