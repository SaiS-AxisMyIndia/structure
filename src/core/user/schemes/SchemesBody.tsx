...
import { useSchemesController } from './SchemesController';

export function SchemesBody() {
  const controller = useSchemesController();
      ...
      body={
        summary ? (
          <>
            ...
            <Text style={styles.stat}>Active schemes: {summary.activeSchemesCount}</Text>
          </>
        ) : null
      }
    />
