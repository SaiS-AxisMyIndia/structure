...
// on, ApiPro\CrashPage is the only thing allowed to decide what a crash
// looks like on the wire.
ini_set('display_errors', '0');
error_reporting(E_ALL);

use ApiPro\CrashPage;
use ApiPro\Kernel;
...
try {
    ...
    // failed to even exist, since nothing api-pro provides is reachable
