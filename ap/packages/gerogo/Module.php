...
/**
 * A registration unit for an application package (e.g. gerogo), equivalent
...
abstract class Module
{
     ...
     * override this at all — gerogo deliberately has no idea what, if
     * anything, a given module does with it (e.g. pro-sql's
     * ProSqlModule uses it to sync entity tables — see its docblock —
     * without gerogo ever needing to depend on pro-sql to make that
     * possible).
     */
