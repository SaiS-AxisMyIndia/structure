...
/**
 * The one place a crash anywhere in gerogo gets written to disk — one
 ...
 * (packages/gerogo/Log.php, always exactly two directories below the
 ...
 * a \Throwable is the last thing standing between gerogo and PHP's own
 * raw error output.
 */
final class Log
{
