...
/**
 * The actual capabilities api-pro's MCP dev-tool server exposes. Every
...
final class ApiProTools
{
    ...
    public function definitions(): array
    {
        ...
        return [
            ...
            [
                'name' => 'apc_install',
                'description' => "Run `apc install` — with no module (or 'api-pro'), validates every app.php module reference actually resolves; with another module name, shows that package's own version and whether/how app.php references it.",
                'inputSchema' => [
                    'type' => 'object',
                    'properties' => [
