...
export function TitleBar({ title, onBackPress, onFontPress, onLogoPress }: TitleBarProps) {
  return (
    ...
    mobile={<MobileTitleBar title={title} onBackPress={onBackPress} onFontPress={onFontPress} onLogoPress={onLogoPress} />}
    tablet={<MobileTitleBar title={title} onBackPress={onBackPress} onFontPress={onFontPress} onLogoPress={onLogoPress} />}
    web={<MainBar onFontPress={onFontPress} onLogoPress={onLogoPress} />}
    />
  );
}

function MobileTitleBar({ title, onBackPress, onFontPress, onLogoPress }: TitleBarProps) {
  return (
